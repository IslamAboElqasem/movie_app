...
class AppColors {
  ...
  static const Color textSecondary = Color(0xFF646464); // Subtitle text
  static const Color chipBorderColor = Color(0xFF9F9F9F); // Genre chip border
  static const Color chipBackground =
      Color(0xFFFFFFFF); // Genre chip background
  ...
  static const Color chipBackgroundDark = Color(0xFF1E1E1E);
  static const Color buttonBackgroundDark = Color(0xFF3A3A3A);
  static const Color buttonTextColorDark = Color(0xFF9F9F9F);
}
